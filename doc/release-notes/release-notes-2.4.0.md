Kawkaw Core version *2.4.0* is now available!!
==============
...
Please report bugs using the issue tracker at GitHub:
  ...
  <https://github.com/KawkawChain/Kawkaw/issues>

To receive security and update notifications, please subscribe to:

  <https://kawkaw.net/en/list/announcements/join/>
...
installer (on Windows) or just copy over `/Applications/Kawkaw-Qt` (on Mac)
or `kawkawd`/`kawkaw-qt` (on Linux).
...
Kawkaw Core is extensively tested on multiple operating systems using
the Linux kernel, macOS 10.8+, and Windows 10(x64) and later. 32-bit versions of Windows,
and Windows XP are not supported.

Kawkaw Core should also work on most other Unix-like systems but is not
frequently tested on them.

Kawkaw Core has been tested with macOS 10.14 Mojave, but it is recommended that *developers*
...
Kawkaw Core has not been tested with macOS Catalina(beta). Please use at your own risk.
...
Changelog available here: <https://github.com/KawkawChain/Kawkaw/commits/release_2.4.0>
...
- Most importantly - The Kawkaw Community!
