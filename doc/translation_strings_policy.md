...
This document provides guidelines for internationalization of the Kawkaw Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `kawkaw_en.ts` remains unchanged.
