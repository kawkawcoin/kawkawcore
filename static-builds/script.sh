...
find ${DISTNAME}/bin -type f -executable -exec ../kawkawcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../kawkawcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/kawkawcoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/kawkawcoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
