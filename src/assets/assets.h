...
#ifndef KAWKAWCOIN_ASSET_PROTOCOL_H
#define KAWKAWCOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_KAWKAW_ASSET KAWQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_KAWKAW_ASSET KAWO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_KAWKAW_ASSET KAWR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_KAWKAW_ASSET KAWT
...
#endif //KAWKAWCOIN_ASSET_PROTOCOL_H
