...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler kaw tx
        CScript kawTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut kawOut(1*COIN, kawTransfer);
        ...
        mutTxTest1.vout.emplace_back(kawOut); 
        ...
        mutTxTest2.vout.emplace_back(kawOut);
        ...
        mutTxTest3.vout.emplace_back(kawOut);
        ...
        mutTxTest4.vout.emplace_back(kawOut);
        ...
        mutTxTest5.vout.emplace_back(kawOut);
        ...
        mutTxTest6.vout.emplace_back(kawOut);
        ...
        mutTxTest7.vout.emplace_back(kawOut);
        ...
        mutTxTest8.vout.emplace_back(kawOut);
