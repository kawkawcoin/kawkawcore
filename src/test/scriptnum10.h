...
#ifndef KAWKAW_TEST_SCRIPTNUM10_H
#define KAWKAW_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Kawkaw Core 0.10.0, for cross-comparison.
 */
public:
