...
#ifndef KAWKAW_QT_GUIUTIL_H
#define KAWKAW_QT_GUIUTIL_H
...
/** Utility functions used by the kawkaw Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "kawkaw:" URI into recipient object, return true on successful parsing
