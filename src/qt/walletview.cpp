...
void WalletView::setKawkawGUI(KawkawGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? KawkawGUI::HD44_ENABLED : _walletModel->hdEnabled() ? KawkawGUI::HD_ENABLED : KawkawGUI::HD_DISABLED);
