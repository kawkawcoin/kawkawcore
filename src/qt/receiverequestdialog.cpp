...
#include "config/kawkaw-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatKawkawURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + KawkawUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatKawkawURI(info));
}
