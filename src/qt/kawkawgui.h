...
#ifndef KAWKAW_QT_KawkawGUI_H
#define KAWKAW_QT_KawkawGUI_H
...
/**
  kawkaw GUI main class. This class represents the main window of the kawkaw UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class KawkawGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit KawkawGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~KawkawGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a kawkaw wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
