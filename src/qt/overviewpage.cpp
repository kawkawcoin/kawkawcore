...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(KawkawUnits::KAW),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->kawkawBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->kawkawBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(KawkawUnits::formatWithUnit(unit, balance, false, KawkawUnits::separatorAlways));
    ui->labelUnconfirmed->setText(KawkawUnits::formatWithUnit(unit, unconfirmedBalance, false, KawkawUnits::separatorAlways));
    ui->labelImmature->setText(KawkawUnits::formatWithUnit(unit, immatureBalance, false, KawkawUnits::separatorAlways));
    ui->labelTotal->setText(KawkawUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, KawkawUnits::separatorAlways));
    ui->labelWatchAvailable->setText(KawkawUnits::formatWithUnit(unit, watchOnlyBalance, false, KawkawUnits::separatorAlways));
    ui->labelWatchPending->setText(KawkawUnits::formatWithUnit(unit, watchUnconfBalance, false, KawkawUnits::separatorAlways));
    ui->labelWatchImmature->setText(KawkawUnits::formatWithUnit(unit, watchImmatureBalance, false, KawkawUnits::separatorAlways));
    ui->labelWatchTotal->setText(KawkawUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, KawkawUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("KAW")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the KAW balance grid from expanding and looking terrible when asset balance is hidden
