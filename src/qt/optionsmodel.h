...
#ifndef KAWKAW_QT_OPTIONSMODEL_H
#define KAWKAW_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for kawkaw client.
...
#endif // KAWKAW_QT_OPTIONSMODEL_H
