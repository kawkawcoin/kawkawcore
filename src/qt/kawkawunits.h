...
#ifndef KAWKAW_QT_KAWKAWUNITS_H
#define KAWKAW_QT_KAWKAWUNITS_H
...
/** kawkaw unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class KawkawUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit KawkawUnits(QObject *parent);
...
typedef KawkawUnits::Unit KawkawUnit;

#endif // KAWKAW_QT_KAWKAWUNITS_H
