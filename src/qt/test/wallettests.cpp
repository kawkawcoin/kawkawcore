...
#include "qt/kawkawamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<KawkawAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_kawkaw-qt -platform xcb      # Linux
//     src/qt/test/test_kawkaw-qt -platform windows  # Windows
//     src/qt/test/test_kawkaw-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = KawkawUnits::formatWithUnit(unit, balance, false, KawkawUnits::separatorAlways);
    ...
    // Amount input
    KawkawAmountField* amountInput = receiveCoinsDialog.findChild<KawkawAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: kawkaw:")) != -1);
