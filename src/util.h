 ...
 */
#ifndef KAWKAW_UTIL_H
#define KAWKAW_UTIL_H
...
extern const char *const KAWKAW_CONF_FILENAME;
extern const char *const KAWKAW_PID_FILENAME;
...
{
    std::string s = strprintf("kawkaw-%s", name);
