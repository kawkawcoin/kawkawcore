...
#ifndef KAWKAW_SCRIPT_STANDARD_H
#define KAWKAW_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_KAWKAW_ASSET script that carries data
    /** KAWKAW END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a kawkaw address
 */
...
/**
 * Generate a Kawkaw scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // KAWKAW_SCRIPT_STANDARD_H
