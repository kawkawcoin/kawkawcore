...
class BIP66Test(KawkawTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # kawkawd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and kawkawd produces more specific reject
            # reasons.
