...
import os
import struct
from test_framework.test_framework import KawkawTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(KawkawTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that kawkaw has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("kawkawd has not been built with zmq enabled.")
