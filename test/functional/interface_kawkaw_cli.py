...
class TestKawkawCli(KawkawTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `kawkaw-cli getinfo`")
        ...
        self.log.info("Compare responses from `kawkaw-cli -getinfo` and the RPCs data is retrieved from.")
