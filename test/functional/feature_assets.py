...
class AssetTest(KawkawTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("KAWKAW1", 1000)
        n0.issue("KAWKAW2", 1000)
        n0.issue("KAWKAW3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="KAWKAW*", verbose=False, count=2, start=-2)
        ...
        kawkaw_assets = n0.listassets(asset="KAWKAW*", verbose=False, count=2, start=-2)
        assert_equal(len(kawkaw_assets), 2)
        assert_equal(kawkaw_assets[0], "KAWKAW2")
        assert_equal(kawkaw_assets[1], "KAWKAW3")
        self.sync_all()
