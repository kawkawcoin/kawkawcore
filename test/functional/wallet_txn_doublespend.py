...
class TxnMallTest(KawkawTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 KAW:
        ...
        # First: use raw transaction API to send 1240 KAW to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 KAW coin each
        ...
        # Node0's balance should be starting balance, plus 50KAW for another
        ...
        # Node0's total balance should be starting balance, plus 100KAW for 
