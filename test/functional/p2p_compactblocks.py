...
# TestNode: A peer we use to send messages to kawkawd, and store responses.
...
class CompactBlocksTest(KawkawTestFramework):
    ...
    # This test actually causes kawkawd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that kawkawd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for kawkawd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # kawkawd will not send blocktxn responses for blocks whose height is
