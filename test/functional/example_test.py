...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the KawkawTestFramework
    pass

class ExampleTest(KawkawTestFramework):
    # Each functional test is a subclass of the KawkawTestFramework class.
    ...
    def custom_method(self):
        ...
        KawkawTestFramework class so other tests can use it."""
