...
By default, kawkawd will dump mempool on shutdown and
...
class MempoolPersistTest(KawkawTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give kawkawd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent kawkawd from writing mempool.dat to disk. Verify that `savemempool` fails")
