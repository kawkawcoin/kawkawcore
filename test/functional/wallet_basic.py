...
class WalletTest(KawkawTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 KAW from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 KAW with subtract fee from amount
        ...
        # Sendmany 10 KAW with subtract fee from amount
